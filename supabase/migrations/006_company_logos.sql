...
update companies set logo_url = '/logos/shop-at-stop.png'           where slug = 'shop-at-stop';
...
update companies set logo_url = '/logos/wd-colledge.jpg'            where slug = 'wd-colledge';
